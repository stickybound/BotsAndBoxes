...
(function () {
  ...
  function updateScore() {
    ...
    scoreEl.innerHTML = 'Boxes — <b class="you">You ' + you + '</b> · <b class="bot">Bot ' + bot + "</b>";
  }
